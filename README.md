...
- 开发模式默认会在原生窗口中载入本地界面
- 如需直接访问服务地址，可使用 `http://127.0.0.1:8765`
...
- `launcher.py`：桌面启动入口（负责初始化、健康检查并拉起原生窗口）
...
目标：客户电脑无需安装 Python、插件或其它依赖，双击图标即可直接打开桌面窗口进入系统。
